        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <div className="aspect-[4/5] overflow-hidden rounded-2xl">
              <img src="/story-origin-2.png" alt="Premium Raw Denim" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center">
            <div className="aspect-[4/5] overflow-hidden rounded-2xl order-2 lg:order-1">
              <img src="/story-process-2.png" alt="Tailor working on Heavyweight process" className="w-full h-full object-cover" />
            </div>
